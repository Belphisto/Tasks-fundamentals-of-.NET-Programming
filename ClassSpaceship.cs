...
namespace Space
{
    public class Spaceship : SpaceObject
    {
       ...
       public Spaceship(string type, string name, string captain, string appointment, double speed, double engin, double penalty, double weight, DateTime launch)
       : base(type, name)
       {
            this._speed = speed;
       ...
       public override double GetSpeed() => _speed*(_engineBonus - _penalty_weight);
